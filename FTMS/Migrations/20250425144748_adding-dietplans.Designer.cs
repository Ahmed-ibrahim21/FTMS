...
namespace FTMS.Migrations
{
    ...
    [Migration("20250425144748_adding-dietplans")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FTMS.models.DietMeal", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FTMS.models.Ingredients", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FTMS.models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "be0338c5-aafa-4932-8a2a-25efbbfac581",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBk11Zp7zOINgEJSCjbVpOWTVWvJK/CVyJeD3uxVbUzfldjZ3k9Sc8oVOm/IZl361Q==",
                            PhoneNumberConfirmed = false,
                            ProfilePic = new byte[0],
                            SecurityStamp = "cbce4691-5161-4861-8c9e-f266fa22419e",
                            TwoFactorEnabled = false,
                            UserName = "admin@gmail.com"
                        });
                });

            modelBuilder.Entity("FTMS.models.WorkoutPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FTMS.models.Ingredients", b =>
                {
                    b.HasOne("FTMS.models.DietMeal", "DietMeal")
            ...
            modelBuilder.Entity("FTMS.models.workoutMove", b =>
                {
                    b.HasOne("FTMS.models.WorkoutPlan", "WorkoutPlan")
                        .WithMany("Moves")
